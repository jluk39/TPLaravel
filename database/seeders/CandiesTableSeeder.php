...
class CandiesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('candies')->insert([
            ...
            ['name' => 'Flynn Paff', 'description' => 'Caramelos masticables de sabores variados', 'type_id' => 4, 'price' => 1300.00, 'image_id' => 6, 'is_visible' => true],
            ['name' => '9 de Oro', 'description' => 'Galletitas ideales para acompañar el mate', 'type_id' => 5, 'price' => 904.00, 'image_id' => 7, 'is_visible' => true],
            ...
            ['name' => 'Mantecol', 'description' => 'Turrón de maní tradicional argentino', 'type_id' => 6, 'price' => 1672.00, 'image_id' => 9, 'is_visible' => true],
            ...
            ['name' => 'D.R.F. Naranja', 'description' => 'Primeras pastillas elaboradas en el país', 'type_id' => 4, 'price' => 283.00, 'image_id' => 12, 'is_visible' => true],
        ]);
    }
}
